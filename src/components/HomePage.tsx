...
export function SpotlightNewDemo() {
  ...
  return (
    <div>
      <div
        className={`min-h-[900px] w-full flex flex-col items-center justify-center
        bg-[--background] relative overflow-hidden
        ${isClient ? "bg-grid" : ""}`}
      >
        {/* Move Spotlight below the content */}
        ...
        <div
          className={`absolute inset-0 ${isClient ? "bg-grid opacity-30" : ""}`}
        />
