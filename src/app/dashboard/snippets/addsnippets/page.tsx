    ...
    >
      <div className="max-w-[1400px] mx-auto">
        <motion.div className="flex items-center gap-2 mb-4 sm:mb-6" variants={itemVariants}>
          ...
          <h1 className="text-lg sm:text-xl font-semibold">New Snippet</h1>
        </motion.div>
            ...
            <Select value={language} onValueChange={setLanguage}>
                ...
                <SelectValue placeholder="Select a language">
                  {language && (
                    <div className="flex items-center gap-2">
                      {languageOptions.find(opt => opt.value === language)?.icon}
              ...
              <SelectContent 
                className="max-h-[300px] overflow-y-auto
                  ...
                  shadow-lg"
              >
                {(['Web', 'Mobile', 'Systems', 'General'] as const).map((category) => (
                  <div key={category}>
